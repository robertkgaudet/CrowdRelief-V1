	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if(HttpContext.Current.User.Identity.IsAuthenticated)
		{
            ...
            if (profile != null && profile.p.DefaultEventId != null)
            {
                ...
                hypDefaultDisaster.NavigateUrl = "/" + disasterEvent.URLFriendlyName + "/" + roleType;
            ...
            lblNonProfitDescription.Text = "CrowdRelief is the Official Disaster Recovery Platform of the ";
            ...
            if (orgUser != null)
			{
				...
				foreach (var myDisasterCampaign in myDisasterCampaigns)
				{
					...
					myDisasterCampaignList += "<li><a href=\"/NonProfitResponse/" + myDisasterCampaign.oe.URLFriendlyCampaignName + "\">" + myDisasterCampaign.oe.CampaignName + "</a></li>";
				}
