						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="hpanel h<%=headerColor%>">
								<div class="panel-heading hbuilt">
									...
									<h4>Cajun Navy Foundation Volunteer Registration</h4>
								</div>
								<div class="panel-body">
									<div id="divFormFields" runat="server" class="divRegisterForm" style="width:600px; padding-bottom:100px;">
										...
										<ul class="m-t">
											...
											<li>I understand there are variations in practice and understanding of volunteerism in some areas of culture. In serving with Cajun Navy Foundation, I will abide by the standards of the project to which assigned in all areas including dress, entertainment, activities, etc. This includes a willing agreement to abstain from the use of alcohol, drugs, and tobacco and being sensitive to cultural and regional expectations and standards.</li>
											<li>In cooperation with the Cajun Navy Foundation, I will seek to provide excellence in attitude and to present a professional outlook at all times.</li>
										</ul>
										<br /><br />
										<div class="hpanel">
								...
								<div class="panel-footer">
									CrowdRelief Community Aid Platform
								</div>
							</div>
						</div>
				</div>
