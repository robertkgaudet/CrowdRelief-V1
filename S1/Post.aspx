							...
							<div class="col-sm-5">
								<div class="hpanel">
									<div class="panel-heading">
										<h2>
											<asp:Literal ID="litSurvivorName" runat="server" Visible="false"></asp:Literal>
										</h2>
										<small><asp:Literal ID="litDisasterName" runat="server" Visible="false"></asp:Literal></small>
									</div>
									<div class="panel-body">
										<dl>
										...
										<p class="m-t-lg">
											This person's information has been vetted and approved by the <a href="http://www.CajunRelief.org" target="_blank">Cajun Navy Foundation</a>.
										</p>
									</div>
								</div>
							</div>
