...
public partial class S1_Default : BaseOrganizationWebForm
{
	...
	//	Master.BoxedBody = true;
		...
		Master.PageTitle		= "CrowdRelief Disaster Survivor Stories";
		Master.FbURL			= Request.Url.AbsoluteUri;
		Master.FbDescription	= "Soon after a disaster such as a hurricane, flood or fire, the nation forgets. CrowdRelief Disaster Survivor Stories bring to life the real struggle faced by citizens seeking to rebuild their lives after losing everything.";
		Master.PageDescription	= "Soon after a disaster such as a hurricane, flood or fire, the nation forgets. CrowdRelief Disaster Survivor Stories bring to life the real struggle faced by citizens seeking to rebuild their lives after losing everything.";
	...
	protected void LoadStories(Guid userId, string category, Guid eventId)
	{
		...
		litName.Text		= "CrowdRelief Disaster Stories";
		...
		foreach(var story in stories)
		{
			...
			if(story.a.CategoryId != null && new Guid(disasterSurvivorStoryCategoryId) == story.a.CategoryId)
			{
				...
				if(story.u.ProfileNumber == articleUser.ProfileNumber)
				{
					...
					"<div class=\"panel-image tinted\">" + Environment.NewLine +
						"<img class=\"img-responsive\" src=\"" + storyPhotoFolder + storyPhoto.FilenameCropped + "\">" + Environment.NewLine +
							"<div class=\"title\">" + Environment.NewLine +
								...
								"<small>CrowdRelief Survivor Stories</small>" + Environment.NewLine +
