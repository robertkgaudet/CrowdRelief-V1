...
<div class="normalheader ">
    <div class="hpanel">
        <div class="panel-body">
            ...
            <small>Welcome to your volunteer profile page.</small>
        </div>
    </div>
</div>
        ...
        <div class="hpanel hgreen" id="divEditScreen" runat="server" visible="false">
            ...
            <div class="panel-body">
				<dl class="dl-horizontal">
					...
					<dt>
						<asp:HyperLink runat="server" id="hypNonProfits" Text="Select Non-Profits" NavigateURL="EditNonProfits.aspx"></asp:HyperLink>
					</dt>
					<dd>
						Which non-profits are you working with?
					</dd>
					<dt>
						<asp:HyperLink runat="server" id="hypDisasters" Text="Choose My Disasters" NavigateURL="EditDisasters.aspx"></asp:HyperLink>
					</dt>
					<dd>
					...
					<dd>
						Print an ID card to show when volunteering.
					</dd>
				</dl>
			</div>
		</div>
