...
public partial class V1_NonProfitNew : BaseOrganizationWebForm
{
	...
	{
		this.Master.PageTitle = "CrowdRelief - Add New Nonprofit";
		this.Master.PageDescription = "Add a new CrowdRelief nonprofit";
		this.Master.FbDescription = "Add a new CrowdRelief nonprofit";
		this.Master.FbImage = "V1/Images/HMichael.png";
		this.Master.FbImageType = "image/jpg";
		this.Master.FbSite_name = "CrowdRelief - Add New Nonprofit";
	...
	protected void btnSubmit_Click(object sender, EventArgs e)
	{
		...
		Response.Redirect("/V1/NonProfit/NonProfit.aspx?organizationId=" + organizationId.ToString());
