...
public partial class V1_NonProfit : BaseOrganizationWebForm
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		if(!IsPostBack)
		{
			...
			litAddNonProfitEvent.Text = "Nonprofits must register with CrowdRelief, to be eligible to create a response to this disaster.";
			//Does somene have a non-profit setup in crowdrelief?
					 ...
					 "<div class=\"panel-body\">" + Environment.NewLine +
						 ...
						 "<div class=\"row\">" + Environment.NewLine +
							 "<div class=\"col-sm-8\">" + Environment.NewLine +
								 "<h4><a href = \"/NonProfitResponse/" + nonProfitCampaign.oe.URLFriendlyCampaignName + "\" >" + nonProfitCampaign.oe.CampaignName + "</a></h4>" + Environment.NewLine +
