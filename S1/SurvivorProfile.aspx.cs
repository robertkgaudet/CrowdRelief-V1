...
public partial class S1_SurvivorProfile : BaseOrganizationWebForm
{
	...
	public void LoadPage()
	{
		...
		this.Master.PageTitle			= "CrowdRelief - " + profile.Firstname + " " + profile.Lastname;
		this.Master.PageDescription		= profile.Firstname + " " + profile.Lastname + " CrowdRelief profile page.";
		this.Master.FbDescription		= profile.Firstname + " " + profile.Lastname + " CrowdRelief profile page.";
		this.Master.FbImage				= "Images/HurricaneMichael.jpg";
		this.Master.FbImageType			= "image/jpg";
		this.Master.FbSite_name			= "CrowdRelief - " +  profile.Firstname + " " + profile.Lastname + " On Facebook";
		...
		else if(volunteerStatus == VolunteerStatus.VettingComplete_Failed.Value)
		{
			...
			litVolunteerStatus.Text = "<b>APPLICATION PENDING REVIEW</b><p>Please contact CrowdRelief regarding your volunteer application.</p>";
		}
		...
		if(profilePhoto != null)
		{
			...
			this.Master.FbSite_name			= "CrowdRelief - " + profile.Firstname + " " + profile.Lastname + " Profile Page";
		}
	}
	...
	protected string GetEvents(Guid userId)
	{
		...
		{
			eventList += "<a href=\"/" + eventItem.URLFriendlyName + "\" style=\"text-decoration:underline;\">" + eventItem.Name + "</a><br/>";
		}
